...
namespace Prism\Prism\Providers\Fireworks;
...
use Prism\Prism\Providers\Fireworks\Handlers\Stream;
use Prism\Prism\Providers\Fireworks\Handlers\Structured;
use Prism\Prism\Providers\Fireworks\Handlers\Text;
...
class Fireworks extends Provider
{
    ...
    public function handleRequestException(string $model, RequestException $e): never
    {
        match ($e->response->getStatusCode()) {
            ...
            529 => throw PrismProviderOverloadedException::make(ProviderName::Fireworks),
            413 => throw PrismRequestTooLargeException::make(ProviderName::Fireworks),
